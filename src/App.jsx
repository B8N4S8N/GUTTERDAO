...
const App = () => {
  ...
  const editionDropAddress = "0x2a111A193984102e56119c1BeB7d1726BD87c2e7"
  
  const { contract: token } = useContract('0x94A8349D7b73787289127563e40b5e80B07a8138', 'token');

  const { contract: vote } = useContract("0xA3c178Cbdf8CDdB45bfF697537A6b00ca484611A", "vote");


  const { contract: editionDrop } = useContract("0x2a111A193984102e56119c1BeB7d1726BD87c2e7", "edition-drop");
  ...
  if (!address) {
    return (
      <div className="landing">
        <h1>Welcome to the <br> Gutter😈Gang!</h1>
